...
You can subscribe to [the feed](feed.xml) for updates.

See [a directory of indie web directory directories](/directory-of-indieweb-directories) for ~~more~~ the other one.
