...
page_title = "indie web directories"
type = "page"
show_in_pages_nav = false
+++

There are indie web directories popping up every day.

This is a directory of those directories.

See [a directory of indie web directory directories](/directory-of-indieweb-directories) for <s>more</s> the other one.
...
- [/interests directory](https://chrisburnell.github.io/interests-directory/)
- [/now garden](https://now.garden/)
- [nownownow](https://nownownow.com/)
- [Top Four](https://topfour.net/#directory)
