+++
date = '2026-03-04T22:36:08Z'
draft = false
title = 'A Morse Note'
tags = ['HWC London']
+++

I get inspired by many things at [HWC London] but somehow the first to make it to my blog is this:
...
To write it I would need to look up the Morse code alphabet, then use it as part of a script.

I was feeling lazy so I used an LLM to do it for me, and it ended up writing the whole thing, including turning it into sound, which I hadn't even asked it to do.

It ruined all of my fun experimenting on a new thing, maybe learning a thing or two.
